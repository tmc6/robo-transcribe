  ...
  <div class="navbar" id="i69mk3">
    <div data-gjs="navbar" class="navbar-container" id="iwtvcs">
      ...
      <div data-gjs="navbar-items" class="navbar-items-c">
       <nav id="incx" class="navbar-menu"><a id="i8xiu" class="navbar-menu-link">Signup</a><a id="iqhsu" href="http://videosubtitle/login.html" class="navbar-menu-link">Login</a><a href="http://videosubtitle/help.html" class="navbar-menu-link" id="izpx3g">Help</a><a id="iflwa" class="navbar-menu-link">Contact <span class="tooltiptext">Email: robot-translate@gmail.com</span></a><a href="http://videosubtitle/" id="iflwv" class="navbar-menu-link">Home</a></nav>
      </div>
    </div>
  </div>
  <div id="iaxsrd"></div>
...
?>
        <div id="id1rci"><label id="ipve0z">Username:</label><input name="username" type="text" id="iwo2xf"/></div>
        <div id="pass"><label id="ihdl4o">Password:</label><input name="password" type="password" id="iun6cz"/><div><br><br> <input type="submit" value="Login" id="iv2s8q"/>
